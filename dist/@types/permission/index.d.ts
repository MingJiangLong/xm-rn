...
export declare const usePermission: <T extends I_PermissionBasicModule, F extends I_BasicFirebase & {
    requestCalendarPermission: (...args: any[]) => Promise<any>;
}>(permissionModule: T, otherModule?: F) => {
